...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr5(a).bin", "chr5(b).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal5(a).bin", "pal5(b).bin"}); }
