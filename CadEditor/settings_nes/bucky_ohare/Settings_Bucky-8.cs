...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr8(a).bin", "chr8(b).bin", "chr8(c).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal8(a).bin", "pal8(b).bin", "pal8(c).bin"}); }
