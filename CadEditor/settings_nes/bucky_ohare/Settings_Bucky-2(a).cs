...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x97b9, 15 , 8*6, 8, 6);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr2(a).bin"}); }
